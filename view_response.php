...
$sql = "SELECT Team_Number, Mentor_Name, Team_Lead, Task_Details FROM burger";
    ...
    <div class="container">
        ...
        <ul class="responsive-table">
            <li class="table-header">
                ...
                <div class="col col-4">Task Details</div>
            </li>
            <?php if (!empty($data)): ?>
                <?php foreach ($data as $row): ?>
                    <li class="table-row">
                        ...
                        <div class="col col-4" data-label="Task Details"><?php echo htmlspecialchars($row['Task_Details']); ?></div>
                    </li>
                <?php endforeach; ?>
            <?php else: ?>
                <li class="table-row">
                    ...
                    <div class="col col-4" data-label="Task Details">N/A</div>
                </li>
            <?php endif; ?>
        </ul>
    </div>
